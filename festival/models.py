...
class DetailIntroFest(models.Model):
    ...
    spend_time_festival =models.CharField(max_length=100)
    booking_place = models.CharField(max_length=100)
    discount_info_festival = models.CharField(max_length=100)
    event_start_date = models.CharField(max_length=100)
    event_end_date = models.CharField(max_length=100)
    sponsor1 = models.CharField(max_length=100)
    sponsor1tel = models.CharField(max_length=100)
    sponsor2 = models.CharField(max_length=100)
    sponsor2tel = models.CharField(max_length=100)
    sub_event = models.CharField(max_length=100)
    use_time_festival = models.CharField(max_length=100)